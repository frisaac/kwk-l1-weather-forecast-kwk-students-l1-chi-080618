...
def tell(weather)
  sentence = "The weather in #{weather[:city]} is #{weather[:description]}. The temperature is #{temperature_farenheit}."
  return tell
end
...
def eacher(weather)
  ...
  puts "The city is #{x}. The description is #{y}. The temperature is #{z}."
end
